...
"""
    Actividad 2: ¿Cuántas calorías consumió Grogu?
"""

calorias_totales = round(grasas_totales*9 + carbo_totales*4 + prote_totales*4)

print("Dado un total de", calorias_totales, "[calorias]")

"""
    Actividad 3: El entrenamiento de Grogu
"""

minutos_fuerza = round(calorias_totales/8)
minutos_resistencia = round(calorias_totales/12)

print("Si Grogu hace entrenamiento de fuerza, debe entrenar", minutos_fuerza, "minutos")
print("Si Grogu hace entrenamiento de resistencia, debe entrenar", minutos_resistencia, "minutos")